...
public class TenderPriceExcelControllerTest extends AbstractExcelControllerTest {
    ...
    public void procurementMethodExcelChart() throws Exception {
        ...
        Assert.assertEquals("chart title",
                translationService.getValue(filter.getLanguage(),"charts:procurementMethod:title"),
    ...
    public void bidSelectionExcelChart() throws Exception {
        tenderPriceExcelController.bidSelectionExcelChart(
        ...
        final XSSFChart chart = charts.get(0);
        Assert.assertEquals("chart title", "Bid selection method", chart.getTitle().getString());
